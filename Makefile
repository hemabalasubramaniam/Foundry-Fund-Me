...
# we can create shortcuts for the things we are going to run in the command line in this file 
# we can simply run make and the the shortcut to run the command Eg: make build => forge build